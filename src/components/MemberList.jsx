...
export const MemberList = () => {
  ...
  return (
    <>
      {
        isLoading ? <Loading text="Loading member list " /> :
          <>
          {
            !hasClaimedNFT ?
              <div className='flex flex-col items-center justify-center w-auto h-full px-20 py-10 rounded-lg shadow-lg bg-neutral-800 shadow-neutral-900'>
                ...
                <Link to='/membership' className="w-full px-4 py-2 leading-loose text-center font-semibold rounded-lg transition-colors duration-150 ease-in-out text-orange-900 hover:text-orange-200 bg-orange-600 hover:bg-orange-800">Join us now</Link>
                </div>
              : <>
