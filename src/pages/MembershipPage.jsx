          ...
          : <section className="flex flex-row h-full py-10">
              <div className="flex flex-col justify-start w-1/2 pt-16">
                ...
                <div className='flex flex-row w-11/12 gap-x-5'>
                  <Link className='w-1/2 px-4 py-2 leading-loose text-center transition duration-150 ease-in-out bg-orange-500 border border-orange-500 rounded-lg text-neutral-900 hover:text-neutral-800 hover:border-orange-700' to="/community">Community access</Link>
                </div>
              </div>
              <div className="w-1/2 p-16">
                <div className='flex flex-col items-center justify-center w-auto h-full px-20 py-10 rounded-lg shadow-lg bg-neutral-800 shadow-neutral-900'>
                  ...
                  <Link className='w-auto px-10 py-2 leading-loose text-center transition duration-150 ease-in-out bg-orange-500 border border-orange-500 rounded-lg text-neutral-900 hover:text-neutral-800 hover:border-orange-700' to="#">Claim NFT</Link>
